...
-- CreateIndex
CREATE INDEX "Task_boardId_isArchived_idx" ON "Task"("boardId", "isArchived");
...
-- CreateIndex
CREATE INDEX "Task_labels_idx" ON "Task"("labels");

-- CreateIndex
CREATE INDEX "Task_company_idx" ON "Task"("company");
